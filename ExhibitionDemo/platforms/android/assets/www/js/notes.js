function getNotes()
{
	...
	$.ajax({
		...
		{ 
			...
			//alert(x);
			$('#notesOutput').append('<a href="eachNote.html" class="item-link close-panel" id="'+id[i]+'" onclick="getEachNote(this)"><div class="card"><div class="card-header" style="color:black"><b>'+notesTitle[i]+'</b></div><div class="card-content" ><div class="card-content-inner" style="padding-left: 15px; padding-right: 5px; padding-top: 5px; padding-bottom: 5px"><pre><font face="Roboto" color="black">'+notes[i]+'</font></pre></div></div></div></a>');
		}
		}
		else
		{
